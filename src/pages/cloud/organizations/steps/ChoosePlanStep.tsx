...
import type { CreateOrgFormData, OrgPlan as OrgPlanType } from '@/schemas/cloud/organizations';
import { OrgPlan } from '@/schemas/cloud/organizations';
...
const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    features: ['Advanced analytics & dashboards', 'Higher API rate limits', 'Webhook integrations', 'Custom branding'],
    moreFeatures: 1,
  },
  {
          ...
          ({
            ...
            const cardInner = (
              <>
                ...
                {badge && (
                  <div
                    className={`absolute top-0 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-xs font-medium ${badgePrimary ? 'border-primary bg-primary text-primary-foreground' : 'bg-background'}`}
                  >
                ...
                <div className="flex flex-col p-6 relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary">{icon}</div>
                    {isSelected && (
                  ...
                  {custom && (
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        window.open('https://vrittiai.com', '_blank');
                      }}
                    >
                      Contact Sales
                    </Button>
